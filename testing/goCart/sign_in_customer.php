			...
			<form method="POST" action="customer/customer_sign_in.php">
				...
				<div class="form-group row">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<input type="email" required class="form-control" id="inputEmail" placeholder="Email" name="email" value="<?php if (isset($_COOKIE["email"])) {
																																echo $_COOKIE["email"];
																															}  ?>">
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<input type="password" required class="form-control" id="inputPassword" placeholder="Password" name="password" value="<?php if (isset($_COOKIE["password"])) {
